...
describe("TagService", () => {
  ...
  describe("findAllByBoardId", () => {
    it("should return all tags for a board", async () => {
      ...
      expect(tags.data[0].id).toBe("1")
      expect(tags.data[0].title).toBe("Tag 1")
      expect(tags.data[0].description).toBe("Desc 1")
      expect(tags.data[1].id).toBe("2")
      expect(tags.data[1].title).toBe("Tag 2")
      expect(tags.data[1].description).toBe("Desc 2")
    })
  })
